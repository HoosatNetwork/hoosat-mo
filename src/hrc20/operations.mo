/// HRC20 Operations
///
/// This module provides JSON formatting functions for HRC20 token operations.
/// All operations follow the HRC20 specification:
...
module {
  ...
  ///
  /// Example: {"p":"hrc-20","op":"deploy","tick":"hoos","max":"2100000000000000","lim":"100000000000"}
  public func formatDeployMint(params: Types.DeployMintParams) : Text {
    var json = "{\"p\":\"hrc-20\",\"op\":\"deploy\",\"tick\":\"" # params.tick # "\"";
    json #= ",\"max\":\"" # params.max # "\"";
    json #= ",\"lim\":\"" # params.lim # "\"";
  ...
  /// Optional fields: to
  ///
  /// Example: {"p":"hrc-20","op":"mint","tick":"hoos"}
  public func formatMint(params: Types.MintParams) : Text {
    var json = "{\"p\":\"hrc-20\",\"op\":\"mint\",\"tick\":\"" # params.tick # "\"";
  ...
  ///
  /// Example: {"p":"hrc-20","op":"transfer","tick":"hoos","amt":"100000000","to":"hoosat:..."}
  public func formatTransferMint(params: Types.TransferMintParams) : Text {
    "{\"p\":\"hrc-20\",\"op\":\"transfer\",\"tick\":\"" # params.tick #
  ...
  ///
  /// Example: {"p":"hrc-20","op":"burn","tick":"hoos","amt":"6600000000"}
  public func formatBurnMint(params: Types.BurnMintParams) : Text {
    "{\"p\":\"hrc-20\",\"op\":\"burn\",\"tick\":\"" # params.tick #
    "\",\"amt\":\"" # params.amt # "\"}"
  };
  ...
  ///
  /// Example: {"p":"hrc-20","op":"list","tick":"test","amt":"292960000000"}
  public func formatList(params: Types.ListParams) : Text {
    ...
    "{\"p\":\"hrc-20\",\"op\":\"list\",\"tick\":\"" # tickLower #
    "\",\"amt\":\"" # params.amt # "\"}"
  };
  ...
  /// CRITICAL: tick must be lowercase for trading operations
  ///
  /// Example: {"p":"hrc-20","op":"send","tick":"test"}
  public func formatSend(params: Types.SendParams) : Text {
    // Ensure tick is lowercase for trading
    let tickLower = toLowercase(params.tick);
    "{\"p\":\"hrc-20\",\"op\":\"send\",\"tick\":\"" # tickLower # "\"}"
  };
  ...
  /// Optional fields: to, dec, pre
  ///
  /// Example: {"p":"hrc-20","op":"deploy","mod":"issue","name":"mytoken","max":"1000000000"}
  public func formatDeployIssue(params: Types.DeployIssueParams) : Text {
    var json = "{\"p\":\"hrc-20\",\"op\":\"deploy\",\"mod\":\"" # params.mod # "\"";
  ...
  /// Optional fields: to
  ///
  /// Example: {"p":"hrc-20","op":"issue","ca":"a0183c1f...","amt":"100000000000"}
  public func formatIssue(params: Types.IssueParams) : Text {
    var json = "{\"p\":\"hrc-20\",\"op\":\"issue\",\"ca\":\"" # params.ca # "\"";
    json #= ",\"amt\":\"" # params.amt # "\"";
  ...
  ///
  /// Example: {"p":"hrc-20","op":"transfer","ca":"a0183c1f...","amt":"100000000","to":"hoosat:..."}
  public func formatTransferIssue(params: Types.TransferIssueParams) : Text {
    "{\"p\":\"hrc-20\",\"op\":\"transfer\",\"ca\":\"" # params.ca #
    "\",\"amt\":\"" # params.amt # "\",\"to\":\"" # params.to # "\"}"
  };
  ...
  /// Required fields: p, op, ca, amt
  ///
  /// Example: {"p":"hrc-20","op":"burn","ca":"a0183c1f...","amt":"6600000000"}
  public func formatBurnIssue(params: Types.BurnIssueParams) : Text {
    "{\"p\":\"hrc-20\",\"op\":\"burn\",\"ca\":\"" # params.ca #
    "\",\"amt\":\"" # params.amt # "\"}"
  };
