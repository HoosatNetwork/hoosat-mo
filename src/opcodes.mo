/// Hoosat Script Opcodes
///
/// This module defines the opcodes used in Hoosat scripts.
/// Most opcodes are compatible with Bitcoin Script, but Hoosat includes
/// additional opcodes like OP_BLAKE2B for BLAKE2B hashing.
///
/// References:
/// - Bitcoin Script opcodes: https://en.bitcoin.it/wiki/Script
/// - Hoosat-specific extensions for BLAKE2B support
...
module {
  ...
  // Crypto - BLAKE2B (Hoosat-specific)
  // Verified from rusty-kaspa source code: 0xAA
  // Bitcoin doesn't have BLAKE2B, so this is a Hoosat extension
  ...
  /// Maximum size for a single OP_PUSH operation in Hoosat (520 bytes)
