/// Script Builder for Hoosat P2SH and HRC20
///
/// This module provides utilities for constructing Hoosat scripts,
/// particularly for HRC20 token operations using the commit-reveal pattern.
///
/// Key functionality:
...
module {
  ...
  /// Build a Hooplex data envelope
  ///
  /// Structure:
  /// OP_FALSE
  /// OP_IF
  ///   OP_PUSH "hooplex"       # Protocol identifier
  ...
  /// OP_ENDIF
  ///
  /// @param protocol - Protocol identifier (e.g., "hoosplex")
  /// @param content - The actual data to embed (e.g., HRC20 JSON)
